...
class Twitter_Service
{
    ...
    {
        $this->oauth = array_merge($this->config, compact('oauth_access_token', 'oauth_access_token_secret', 'consumer_key', 'consumer_secret', 'user_id', 'screen_name', 'count'));
    }
    ...
    public function get($url) {
        ...
        $oauth = [
            ...
            'oauth_token' => $this->oauth['oauth_access_token'],
